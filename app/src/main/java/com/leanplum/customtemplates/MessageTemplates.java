...
public class MessageTemplates {
    ...
    public synchronized static void register(Context currentContext/*, DataManager dataManager*/) {
        if (registered) {
            return;
        }
        registered = true;
        ...
        // GyG custom dialogs (c) Maksym Lazarenko
//        Timber.d("Leanplum start register custom GYG dialogs");
        GYGPushPrePermission.register(currentContext);
        GYGRateDialog.register(/*dataManager*/);
        GYGFeedbackDialog.register();
        GYGSimpleGraciasDialog.register();
        GYGExpandedGraciasDialog.register();
    }
}
